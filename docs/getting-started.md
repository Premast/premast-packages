...
When a new version is released, make sure npm is authenticated with GitHub Packages first — otherwise the version check silently falls back to your installed version and reports it as "latest":
