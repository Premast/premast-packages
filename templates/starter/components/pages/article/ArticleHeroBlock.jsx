import styles from "./ArticleHeroBlock.module.css";

export default function ArticleHero({ title, subtitle, placeholderLabel, placeholderHeight }) {
   return (
...
export const ArticleHeroBlock = {
   ...
   render: ({ title, subtitle, placeholderLabel, placeholderHeight }) => (
      <ArticleHero title={title} subtitle={subtitle} placeholderLabel={placeholderLabel} placeholderHeight={placeholderHeight} />
   ),
};
